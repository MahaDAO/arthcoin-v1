...
contract ShareWrapper is StakingTimelock {
    ...
    function withdraw(uint256 amount) public virtual checkLockDuration {
        ...
        require(
            ...
            'ArthBoardroom: withdraw request greater than staked amount'
        );
...
contract ArthBoardroom is ShareWrapper, ContractGuard, Operator {
    using SafeERC20 for IERC20;
    ...
    modifier directorExists {
        require(
            ...
            'ArthBoardroom: The director does not exist'
        );
        _;
    }
    ...
    {
        require(amount > 0, 'ArthBoardroom: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        updateReward(msg.sender)
    {
        require(amount > 0, 'ArthBoardroom: Cannot withdraw 0');
    ...
    function allocateSeigniorage(uint256 amount)
        ...
        onlyOperator
    {
        require(amount > 0, 'ArthBoardroom: Cannot allocate 0');
        require(
            totalSupply() > 0,
            'ArthBoardroom: Cannot allocate when totalSupply is 0'
        );
